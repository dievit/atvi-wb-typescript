...
var Empresa = /** @class */ (function () {
    ...
    Empresa.prototype.preCadastrarClientes = function () {
        var _this = this;
        ...
        listaDeClientes.forEach(function (cliente) {
            _this.clientes.push(new cliente_1.default(dataCadastro, cliente.nome, cliente.cpf, cliente.telefone, ""));
        });
    };
    Empresa.prototype.preCadastrarProdutos = function () {
        var _this = this;
        var listaDeProdutos = [
        ...
        listaDeProdutos.forEach(function (produto) {
            _this.produtos.push(new produto_1.default(produto.nome, produto.categoria, produto.dataValidade, produto.preco, produto.custo));
        });
    };
